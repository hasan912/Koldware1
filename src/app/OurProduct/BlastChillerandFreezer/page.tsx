        ...
        <div className="container mx-auto flex items-center justify-center xl:justify-start">
          <motion.div
            ...
            <div className='md-[20px]'>
              {/* label */}
              <Label htmlFor='destination' className='text-5xl text-[#034EA2]'>Blast-In Chillers and Freezers</Label>
              {/* input & icon  */}
              <div className='relative flex text-white font-semibold items-center mb-[20px]'>
                <p>Quite large variety of Polyurethane insulated doors (Hinges and Sliding) are available to suite customer’s requirement with high quality fittings and other accessories (safety release handles, gaskets, aluminum or stainless steel railing, etc.)</p>
              </div>
              {/* date picker */}
            </div>
            {/* slect, checkbox, btn */}
