        ...
        <div className="container mx-auto flex items-center justify-center xl:justify-start">
          <motion.div
            ...
            <div className='md-[20px]'>
              {/* label */}
              <Label htmlFor='destination' className='text-5xl text-[#034EA2]'>Polyurethane Insulated Sandwich Panels</Label>
              {/* input & icon  */}
              <div className='relative flex text-white font-semibold items-center mb-[20px]'>
                <p>We use a variety of insulated wall and ceiling panels dependent upon the specific client needs and budget. Whether refrigerated or non-refrigerated, the panels we use will exceed your requirement and provide the best insulation value for your investment.</p>
              </div>
              {/* date picker */}
            </div>
            {/* slect, checkbox, btn */}
        ...
        >
          ...
          <div className='flex mt-10 flex-col xl:flex-row xl:pl-[100px] gap-y-12 xl:gap-y-0'>
            ...
            <div className='max-w-[445px] xl:max-w-[900px] xl:pt-8 order-2 xl:order-1 text-center mx-auto xl:text-left xl:mx-0' >
              <h2 className='h2 text-[#034EA2] mb-4'>Polyurethane Insulated Sandwich Panels</h2>
            ...
            <div className='order-1 xl:order-2 flex-1 justify-center xl:justify-end relative h-[634px]'>
              <div>
                <Image src={"/ourproduct/pannel.jpg"} width={905} height={528} quality={100} alt='' className=' xl:rounded-tl-[25px] xl:rounded-bl-[25px]' />
                <div className='bg-soft_green p-4 text-white xl:ml-10 text-center xl:text-left xl:max-w-[668px] xl:min-h-[180px] xl:absolute xl:bottom-0 md:flex-col md:max-w-[900px] xl:rounded-xl xl:px-10'>
                  <p className='mb-3 max-w-md mx-auto xl:max-w-none xl:mx-0 xl:mb-6'>We use highest quality of Polyurethane which is CFC free that significantly reduces ozone depleting effects to (on) the Earth's atmosphere and also use a foam-in-place continuous line panel manufacturing process that ensures is (is?) superior panel with consistently high quality.</p>
