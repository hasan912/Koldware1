  ...
  return (
    <footer className="bg-soft_green-secondary  relative pt-12 xl:pt-0">
      <div className="container mx-auto">
        ...
        > 
          <div className="flex flex-cols xl:flex-row bg-white p-8 rounded-xl min-h-[394px] xl:p-20 xl:-translate-y-36 xl:gap-x-12">
            {/* logo & text */}
            <div className="pb-16 pt-4 sm:pt-10 lg:pt-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-2 lg:grid-cols-5 lg:gap-8 lg:pt-12">
      <div className="col-span-full lg:col-span-2">
        ...
        <div className="mb-4 lg:-mt-2">
          <a
            ...
            aria-label="logo"
          >
            <Image src='/footer/KWI-ICON.svg' width={80} height={36} className="h-full w-[100px]" quality={100} alt=""/>
        ...
        <nav className="flex flex-col gap-4">
          ...
          <div>
            <Link
              ...
              className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
            >
              Refrigerated ContainerTruck & Van
            </Link>
          </div>
        </nav>
      </div>
        ...
        <nav className="flex flex-col gap-4">
          ...
          <div>
            <Link
              ...
              className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
            >
              Controlled Atmosphere CA Store
            </Link>
          </div>
          <div>
            <a
      ...
      <motion.div  variants={FadeIn('down',0.4)}
        initial='hidden'
        whileInView={'show'}
        viewport={{once:false,amount:0.4}} className="bg-gray-100">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex items-center justify-between gap-4 py-8">
      <span className="text-lg text-gray-400">
        {" "}
        © 2024 - Present by Muhammad Hasan Baig & Muhammad Sufiyan Baig. All rights reserved.{" "}
      </span>
      {/* social - start */}
